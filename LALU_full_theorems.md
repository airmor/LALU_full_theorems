...
说明：本文件按原讲义章节顺序汇总所有定义、定理与引理；无标签项将以简短描述标识并编号。数学公式使用 KaTeX 语法。已对照 [LALU定理汇总3.md](LALU定理汇总3.md) 做过人工复核，并把其中原先压缩或遗漏的关键结论补入正文对应章节。
...
**定理 24.3.3 (变量代换公式)**  可逆可微变换下积分满足 Jacobian 行列式变换律。
